        ...
        {Categories &&
          Categories.map((cate, index) => (
            <CarouselItem key={index + 1} className="pl-1  basis-1/7">
              <div className="p-1">
                <Card
                  className="rounded-full px-1 py-0.5 overflow-hidden cursor-pointer group hover:bg-gray-100 duration-300 transition-colors"
                ...
                >
                  <CardContent className="relative w-full h-full p-0 flex items-center justify-center">
                    <span className="group relative z-10 text-gray-600 font-semibold text-sm ">
                      {cate.label}
                    </span>
                  </CardContent>
                </Card>
